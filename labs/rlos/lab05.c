...
1. Зачем создавать два разных процесса для чтения и записи? Все так же это можно было делать и в одном процессе ***Ответ*** чтобы считывать входные сообщения и не ждать простоя от scanf;
2. Зачем тратить ресурсы для того чтобы перед каждой записью/чтением инициализировать канал связи? ***Ответ*** исправил. ошибочка была :)
3. И конечно жаль что вы не захотели делать чат с ботами. ***Ответ*** сделалано :D
